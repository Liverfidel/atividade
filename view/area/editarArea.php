...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo $path; ?>/repositorio/area/editarArea.php" method="POST">
            <input value="<?php echo $linha['idArea'] ?>" type="text" name="identidade" id="idArea" hidden>
            <div class="row mb-3">
                <div class="col col-md-8">
                    <label class="form-label" for="idnome">Nome</label>
                    <input class="form-control" value="<?php echo $linha['nomeArera'] ?>" type="text" name="nome"
                        id="idnome">
                </div>
            </div>
            <?php 
